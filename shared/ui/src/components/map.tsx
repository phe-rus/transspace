...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  useEffect(() => {
    ...
    const map = new MapLibreGL.Map({
      ...
      // MapOptions.attributionControl has no `position` field, so the
      // default corner (bottom-right) can't be set this way — it collides
      // with a fixed-position language switcher many host apps put there.
      // Disabled here and added back explicitly, at bottom-left, below.
