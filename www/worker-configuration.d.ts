/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 80a9afda2b70225a3045883bd0c0d68b)
// Runtime types generated with workerd@1.20260828.1 2026-02-09 nodejs_compat
interface __BaseEnv_Env {
	NODE_ENV: string;
	VITE_APP_SERVER: string;
	INLANG_MACHINE_TRANSLATE_PROVIDER: string;
	INLANG_GOOGLE_TRANSLATE_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "VITE_APP_SERVER" | "INLANG_MACHINE_TRANSLATE_PROVIDER" | "INLANG_GOOGLE_TRANSLATE_API_KEY">> {}
}
