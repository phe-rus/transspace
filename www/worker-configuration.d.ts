/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e3e5aab85d6ab2aca5c04f19a777efaf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "VITE_APP_SERVER">> {}
}
